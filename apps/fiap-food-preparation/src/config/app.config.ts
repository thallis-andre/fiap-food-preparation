...
export class AppConfig implements CommonOptionsFactory {
  ...
  createOptions(): CommonModuleOptions {
    ...
    return {
      ...
      openApiServers: [
        // ::KeepStyle::
        // { url: 'https://app.fiapfood.dev', description: 'production' },
        // { url: 'https://stg-app.fiapfood.dev', description: 'staging' },
        // { url: 'https://dev-app.fiapfood.dev', description: 'development' },
